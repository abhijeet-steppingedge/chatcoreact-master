...
var Checkout = function Checkout(props) {
  ...
  var handlerClickPlaceOrder = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(paymentOptions) {
    ...
    return function handlerClickPlaceOrder(_x2) {
  ...
  (0, _react.useEffect)(function () {
    if (paymethodSelected) {
      dispatch({
        type: 'ADD_SELECTED_PAYMETHOD',
        payload: paymethodSelected
      });
    }
    if (!paymethodSelected) {
