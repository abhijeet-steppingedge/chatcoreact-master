      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            categoryState.products.forEach(function (product) {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            if (shop !== null && shop !== void 0 && shop.menu && Object.keys(shop === null || shop === void 0 ? void 0 : shop.menu).length > 0) {
              // parameters.menu_id = shop?.menu?.id;
            }
            ...
            // }
            _context6.next = 9;
            return ordering.businesses(slug)
            // .select(businessProps)  for table numbers field
          ...
          case 9:
            ...
            if (result.menus && result.menus.length) {
              result.menus = result.menus.filter(function (menu) {
