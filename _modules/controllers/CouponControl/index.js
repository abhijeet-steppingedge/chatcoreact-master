...
var CouponControl = function CouponControl(props) {
  ...
  var couponDefault = shop.couponCode;
  var _useState5 = (0, _react.useState)(null),
    _useState6 = _slicedToArray(_useState5, 2),
    couponInput = _useState6[0],
    setCouponInput = _useState6[1];

  /**
   * method to manage coupon apply button
   */
  var handleButtonApplyClick = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _configs$advanced_off;
      var requestOptions, response, _yield$response$json, result, error, offer, offerPrice, validDate, allowed, errors, str_types, _errors;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            setStateValues(_objectSpread(_objectSpread({}, orderState), {}, {
              loading: true
            }));
            requestOptions = {
              method: 'GET',
            ...
            _context.next = 5;
            return fetch("https://apiv4.ordering.co/".concat(_config.default.api.version, "/").concat(_config.default.api.language, "/").concat(_config.default.project, "/business/").concat(businessId, "/offers"), requestOptions);
          case 5:
          ...
          case 8:
            ...
            offer = result.filter(function (bOffer) {
              return (bOffer === null || bOffer === void 0 ? void 0 : bOffer.coupon) == couponInput;
            });
            ...
            offer = offer[0];
            offerPrice = offer.rate_type == 1 ? offer.rate / 100 * shop.totalPrice : offer.rate; // var startDate = new Date(offer.start)
            //   , endDate = new Date(offer.end)
            //   , date = moment()
            //   , range = moment().range(startDate, endDate)
            //   , validDate = range.contains(date);
            validDate = (0, _utils.dateCheck)(moment(offer.start), moment(offer.end), moment());
            console.log('validDate', validDate);
            allowed = offer.order_types_allowed === null || offer.order_types_allowed !== null && Object.values(offer.order_types_allowed).length && Object.values(offer.order_types_allowed).includes(orderState.options.type);
            ...
            errors = [];
            if (!validDate) {
              errors.push("This Coupon is only applicable from ".concat(offer.start, " to ").concat(offer.end));
            }
            if (!offer.enabled) {
              errors.push("This Coupon is not available!");
            }
            if (!allowed) {
              str_types = offer.order_types_allowed !== null && Object.keys(offer.order_types_allowed).length > 0 ? (0, _utils.getOrderTypetext)(offer.order_types_allowed) : 'Sorry, Coupon is not available!';
              errors.push("This Coupon is only applicable for ".concat(str_types));
            }
            if (shop.totalPrice < offer.minimum) {
              errors.push("To use this coupon you must have a purchase of $ ".concat(offer.minimum));
            }
            setAlertState({
              open: true,
              content: errors
          ...
          case 41:
            _errors = [];
            _errors.push("Invalid Coupon Code!");
            setAlertState({
              open: true,
              content: _errors
            });
    ...
    return function handleButtonApplyClick() {
