...
var _BiCreditCard = _interopRequireDefault(require("@meronex/icons/bi/BiCreditCard"));
...
var _PaymentOptions = require("../../controllers/PaymentOptions");
...
var stripeOptions = ['stripe_direct'];
...
var getPayIcon = function getPayIcon(method) {
  switch (method) {
    ...
    case 28:
      return /*#__PURE__*/_react.default.createElement(_BiCreditCard.default, null);
    case 31:
...
var PaymentOptionsUI = function PaymentOptionsUI(props) {
  var _props$beforeElements, _props$beforeComponen, _paymethodsList$error, _paymethodSelected$da, _paymethodData$card, _paymethodData$card2, _isOpenMethod$paymeth, _isOpenMethod$paymeth2, _isOpenMethod$paymeth3, _isOpenMethod$paymeth4, _props$afterComponent, _props$afterElements;
  var cart = props.cart,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
  ...
  }), paymethodsList.error && paymethodsList.error.length > 0 && /*#__PURE__*/_react.default.createElement(_orderingUi.NotFoundSource, {
    ...
    open: (isOpenMethod === null || isOpenMethod === void 0 ? void 0 : (_isOpenMethod$paymeth = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth === void 0 ? void 0 : _isOpenMethod$paymeth.gateway) === 'stripe_direct' && !paymethodData.id,
    className: "modal-info",
    onClose: function onClose() {
      return handlePaymethodClick(null);
    }
  }, (isOpenMethod === null || isOpenMethod === void 0 ? void 0 : (_isOpenMethod$paymeth2 = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth2 === void 0 ? void 0 : _isOpenMethod$paymeth2.gateway) === 'stripe_direct' && /*#__PURE__*/_react.default.createElement(_StripeElementsForm.StripeElementsForm, {
...
var PaymentOptions = function PaymentOptions(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_PaymentOptions.PaymentOptions, paymentOptions);
};
