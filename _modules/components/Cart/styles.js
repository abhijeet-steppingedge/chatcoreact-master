...
exports.WarningMessage = exports.Spinner = exports.SectionProduct = exports.SavedContainer = exports.ProductQuantity = exports.ProductActions = exports.OrderBill = exports.IconContainer = exports.Divider = exports.CouponContainer = exports.CommentContainer = exports.CheckoutAction = exports.CartSticky = exports.CartContainer = void 0;
...
var Spinner = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  transform: translate(-20%, 15%);\n"])));
exports.Spinner = Spinner;
var CommentContainer = _styledComponents.default.td(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  position: relative;\n  .spinner-content > div{\n    width: 50px;\n    height: 50px;\n  }\n"])));
...
var SavedContainer = _styledComponents.default.span(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n  font-size: 20px;\n  font-weight: bold;\n  color: ", ";\n  background: ", ";\n  padding: 5px 10px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n"])), function (props) {
...
var ProductActions = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: left;\n  justify-content: left;\n  padding: 20px 0px;\n  width: 30%;\n  z-index: 99;\n\n  position: fixed;\n  bottom: 0;\n  right: 0;\n  background-color: #FFF;\n\n  div.incdec-control {\n    justify-content: left;\n    align-items: left;\n\n    svg {\n      width: 30px;\n      height: 30px;\n      cursor: pointer;\n      margin-top:10px;\n    }\n  }\n  div:last-child {\n    width: 100%;\n    display: flex;\n    align-items: right;\n  }\n\n  button:disabled,\n  button.disabled,\n  svg.disabled {\n    opacity: 0.5;\n  }\n\n  svg.disabled {\n    pointer-events: none;\n  }\n\n  svg.icon {\n    padding-top:6px;\n  }\n\n  button.add {\n    padding: 5px 15px;\n    margin: 10px 0px 0px;\n    width: 91%;\n\n    &.soldout {\n      position: relative;\n      pointer-events: none;\n    }\n\n    > span.total {\n      ", "\n    }\n  }\n\n  @media (min-width: 577px) {\n    flex-direction: row;\n\n    div:last-child {\n      width: 75%;\n    }\n    button.add {\n      width: initial;\n      margin: 0 10px;\n\n      &.soldout {\n        width: 100%;\n      }\n    }\n\n    button {\n      position: absolute;\n\n      ", "\n    }\n  }\n\n  @media (min-width: 769px) {\n    position: sticky;\n    bottom: 0px;\n    right: initial;\n  }\n\n  @media (min-width: 1201px) {\n    padding: 10px 0px;\n\n    div:last-child {\n      width: 70%;\n      button {\n        width: 100%;\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme4;
...
var SectionProduct = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\nheight: 80px;\nwidth: 100%;\ndisplay: flex;\nflex-direction: row;\nz-index: 99;\nmargin:10px 0px;\nborder-bottom:1px solid #cccccc;\n"])));
exports.SectionProduct = SectionProduct;
var ProductQuantity = _styledComponents.default.span(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  border-radius: 4px;\n  width: 20px;\n  height: 20px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin: 20px 15px;\n"])));
