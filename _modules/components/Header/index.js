...
var _TrackOrderPopover = require("../TrackOrderPopover");
...
var Header = function Header(props) {
  ...
  var business = (0, _reactRedux.useSelector)(function (state) {
    return state.shop.business;
  });
  ...
  var _useState13 = (0, _react.useState)({
    ...
    customConfigTypes = _useState14[0],
    setCustomConfigTypes = _useState14[1];
  ...
  (0, _react.useEffect)(function () {
    business && Object.keys(business).length > 0 ? getCustomConfigTypes(business === null || business === void 0 ? void 0 : business.menus) : null;
  }, [business]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
    ...
    home: isHome
  }, /*#__PURE__*/_react.default.createElement(_styles.InnerHeader, null, /*#__PURE__*/_react.default.createElement(_styles.LeftHeader, null, isShowOrderOptions && /*#__PURE__*/_react.default.createElement(_styles.Menu, {
    className: "left-header"
  }, (pathname.includes('/checkout') || pathname.includes('/orders')) && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'row',
      cursor: 'pointer',
  ...
  }, 'Back')), !(configState !== null && configState !== void 0 && configState.loading) && !customConfigTypes.isGetting && !pathname.includes('/orders') && /*#__PURE__*/_react.default.createElement(_OrderTypeSelectorHeader.OrderTypeSelectorHeader, {
    configTypes: customConfigTypes.configTypes.length > 0 ? customConfigTypes.configTypes : configTypes
  }), onlineStatus && windowSize.width > 992 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles.AddressWrapper, null, /*#__PURE__*/_react.default.createElement(_AddressesPopover.AddressesPopover, {
    auth: auth,
    business: business,
    ...
    isHome: isHome
  }), isFarAway && /*#__PURE__*/_react.default.createElement(_styles.FarAwayMessage, null, /*#__PURE__*/_react.default.createElement(_TiWarningOutline.default, null), /*#__PURE__*/_react.default.createElement("span", null, t('YOU_ARE_FAR_FROM_ADDRESS', 'You are far from this address'))))))), onlineStatus && /*#__PURE__*/_react.default.createElement(_styles.RightHeader, null)), onlineStatus && isShowOrderOptions && (windowSize.width > 768 && windowSize.width <= 992 ? /*#__PURE__*/_react.default.createElement(_styles.SubMenu, null, /*#__PURE__*/_react.default.createElement(_styles.AddressWrapper, null, /*#__PURE__*/_react.default.createElement(_AddressesPopover.AddressesPopover, {
    auth: auth,
    business: business,
    ...
    isHome: isHome
  }), isFarAway && /*#__PURE__*/_react.default.createElement(_styles.FarAwayMessage, null, /*#__PURE__*/_react.default.createElement(_TiWarningOutline.default, null), /*#__PURE__*/_react.default.createElement("span", null, t('YOU_ARE_FAR_FROM_ADDRESS', 'You are far from this address'))))) : /*#__PURE__*/_react.default.createElement(_styles.SubMenu, null, /*#__PURE__*/_react.default.createElement(_styles.AddressWrapper, null, /*#__PURE__*/_react.default.createElement(_orderingUi.HeaderOption, {
    variant: "address",
    ...
    isHome: isHome
  }), isFarAway && /*#__PURE__*/_react.default.createElement(_styles.FarAwayMessage, null, /*#__PURE__*/_react.default.createElement(_TiWarningOutline.default, null), /*#__PURE__*/_react.default.createElement("span", null, t('YOU_ARE_FAR_FROM_ADDRESS', 'You are far from this address')))))), modalIsOpen && /*#__PURE__*/_react.default.createElement(_orderingUi.Modal, {
  ...
  }, modalSelected === 'cart' && /*#__PURE__*/_react.default.createElement(_orderingUi.CartContent, {
    carts: cartsWithProducts,
    isOrderStateCarts: !!orderState.carts,
    onClose: function onClose() {
      return setModalIsOpen(false);
    }
  }), modalSelected === 'address' && /*#__PURE__*/_react.default.createElement(_AddressForm.AddressForm, {
    business: business,
