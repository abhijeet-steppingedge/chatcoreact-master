...
var ProductItemAccordion = function ProductItemAccordion(props) {
  var _props$beforeElements, _props$beforeComponen, _product$total_price, _props$afterComponent, _props$afterElements;
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
    ...
    isValid: true,
    className: "product accordion toggle-accordion ".concat(setActive),
    onClick: function onClick(e) {
      return toggleAccordion(e);
    }
  }, /*#__PURE__*/_react.default.createElement(_styles.ProductInfo, {
    className: "info"
  }, /*#__PURE__*/_react.default.createElement(_styles.ContentInfo, null, /*#__PURE__*/_react.default.createElement("h3", null, product.name), windowSize.width > 410 && /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement("p", null, parsePrice((_product$total_price = product.total_price) !== null && _product$total_price !== void 0 ? _product$total_price : product.total_price)), false && isCartProduct && /*#__PURE__*/_react.default.createElement("div", null, onDeleteProduct && /*#__PURE__*/_react.default.createElement("span", {
    ref: productActionsDelete
  }, /*#__PURE__*/_react.default.createElement(_VscTrash.default, {
    color: "#D81212",
    onClick: function onClick() {
      return onDeleteProduct(product.code, product.total_price);
    }
  }))))), /*#__PURE__*/_react.default.createElement(_QuantityControl.QuantityControl, {
    increment: increment,
    decrement: decrement,
    product: product
  }), false && windowSize.width < 410 && /*#__PURE__*/_react.default.createElement(_styles.ProductPriceSection, null, /*#__PURE__*/_react.default.createElement(_styles.ProductPrice, {
    className: "prod-price"
  }, /*#__PURE__*/_react.default.createElement("span", null, parsePrice(product.total_price)), (productInfo().ingredients.length > 0 || productInfo().options.length > 0 || product.comment) && /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_IosArrowDown.default, {
    className: "toggle-accordion ".concat(setRotate)
  }))), isCartProduct && /*#__PURE__*/_react.default.createElement(_styles.ProductActions, null, /*#__PURE__*/_react.default.createElement(_styles.ProductActionsDelete, {
    ref: productActionsDelete,
    onClick: function onClick() {
      return onDeleteProduct(product.code, product.total_price);
    },
    ...
    color: "#D81212"
  })))), productInfo().ingredients.length > 0 || productInfo().options.length > 0 || product.comment ? /*#__PURE__*/_react.default.createElement("p", {
    style: {
      cursor: 'pointer'
    }
