...
var ProductOptionsUI = function ProductOptionsUI(props) {
  var _props$beforeElements, _props$beforeComponen, _props$beforeMidEleme, _props$beforeMidCompo, _theme$images, _theme$images$dummies, _theme$defaultLanguag, _theme$defaultLanguag2, _props$afterMidElemen, _props$afterMidCompon, _error$, _props$afterComponent, _props$afterElements;
  ...
  var _useState = (0, _react.useState)({
    ...
    productInCart = _useState2[0],
    setProductInCart = _useState2[1];
  ...
  var _useState3 = (0, _react.useState)(productCart === null || productCart === void 0 ? void 0 : productCart.total),
    _useState4 = _slicedToArray(_useState3, 2),
    totalProductPrice = _useState4[0],
    setTotalProductPrice = _useState4[1];
  var _useState5 = (0, _react.useState)(1),
    _useState6 = _slicedToArray(_useState5, 2),
    productQty = _useState6[0],
    setProductQty = _useState6[1];
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (Object.keys(product.ingredients).length > 0 || Object.keys(product.options).length > 0) {
              product['code'] = (0, _utils.generateUniqueCode)(5);
            }
            for (i = 1; i <= productQty; i++) {
              props.addItemToCart(product, business);
            }
            getCurrentProduct(_objectSpread(_objectSpread({}, product), {}, {
              qty: productQty
            }));
            onSave(product);
  ...
  var increment = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var _productInCart$exists;
      var qty, totalPrice;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            qty = productQty + 1;
            totalPrice = productCart.total * qty;
            setProductQty(qty);
            setTotalProductPrice(totalPrice);
            (_productInCart$exists = productInCart.exists) !== null && _productInCart$exists !== void 0 ? _productInCart$exists : props.changeQuantity(product.code, qty, 'plus', productCart.total);
  ...
  var decrement = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var qty, totalPrice, _productInCart$exists2;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            setTotalProductPrice(totalPrice);
            if (qty >= 1) {
              (_productInCart$exists2 = productInCart.exists) !== null && _productInCart$exists2 !== void 0 ? _productInCart$exists2 : props.changeQuantity(product.code, qty, 'minus', productCart.total);
            } else {
  ...
  var getCurrentProduct = function getCurrentProduct() {
    var justAddedProduct = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var item = justAddedProduct;
    var itemLength = Object.keys(justAddedProduct).length;
    if (itemLength == 0) {
      var cart = props.cart.shop.cart;
    ...
    setProductInCart({
      exists: itemLength > 0 ? true : false,
      product: itemLength > 0 ? item : {}
    });
  };
  ...
  // }, [productInCart])
  (0, _react.useEffect)(function () {
    var totalPrice = productCart.total * productQty;
    setTotalProductPrice(totalPrice);
  }, [productCart]);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
    ...
    className: 'isIndividualBusinessCart-ProductAction'
    ...
    onClick: decrement,
    className: "".concat(isSoldOut || productQty == 1 ? 'disabled' : '')
  }), /*#__PURE__*/_react.default.createElement(_styles.ProductQuantity, null, productQty), /*#__PURE__*/_react.default.createElement(_FiPlusCircle.default, {
    onClick: increment,
    className: "".concat(maxProductQuantity <= 0 || productQty >= maxProductQuantity || isSoldOut ? 'disabled' : '')
  })), productCart && !isSoldOut && maxProductQuantity > 0 && /*#__PURE__*/_react.default.createElement(_orderingUi.Button, {
  ...
  }, orderState.loading ? /*#__PURE__*/_react.default.createElement("span", null, t('LOADING', 'Loading')) : /*#__PURE__*/_react.default.createElement("span", null, editMode ? t('UPDATE', 'Update') : t('ADD_TO_CART', 'Add to Cart')), /*#__PURE__*/_react.default.createElement("span", {
    className: "total"
  }, totalProductPrice && parsePrice(totalProductPrice)))))), error && error.length > 0 && /*#__PURE__*/_react.default.createElement(_orderingUi.NotFoundSource, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    addItemToCart: function addItemToCart(product, business) {
      return dispatch({
        type: 'ADD_TO_CART',
        payload: {
          product: product,
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ProductForm);
