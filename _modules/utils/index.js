...
exports.verifyDecimals = exports.sortInputFields = exports.showField = exports.scrollTo = exports.reviewCommentList = exports.isRequiredField = exports.getTraduction = exports.getOrderTypetext = exports.getOrderTypeInt = exports.getIconCard = exports.getHourMin = exports.getGoogleMapImage = exports.getFixedFromPercentage = exports.getDistance = exports.generateUniqueCode = exports.formatUrlVideo = exports.formatSeconds = exports.flatArray = exports.fieldsToSort = exports.dateCheck = exports.convertToRadian = exports.convertHoursToMinutes = exports.capitalize = exports.bytesConverter = void 0;
...
var isRequiredField = function isRequiredField(fieldName) {
  ...
  return _validationFields.default && !_validationFields.default.loading && ((_validationFields$fie = _validationFields.default.fields) === null || _validationFields$fie === void 0 ? void 0 : (_validationFields$fie2 = _validationFields$fie.checkout) === null || _validationFields$fie2 === void 0 ? void 0 : _validationFields$fie2[fieldName]) && ((_validationFields$fie3 = _validationFields.default.fields) === null || _validationFields$fie3 === void 0 ? void 0 : (_validationFields$fie4 = _validationFields$fie3.checkout) === null || _validationFields$fie4 === void 0 ? void 0 : (_validationFields$fie5 = _validationFields$fie4[fieldName]) === null || _validationFields$fie5 === void 0 ? void 0 : _validationFields$fie5.enabled) && ((_validationFields$fie6 = _validationFields.default.fields) === null || _validationFields$fie6 === void 0 ? void 0 : (_validationFields$fie7 = _validationFields$fie6.checkout) === null || _validationFields$fie7 === void 0 ? void 0 : (_validationFields$fie8 = _validationFields$fie7[fieldName]) === null || _validationFields$fie8 === void 0 ? void 0 : _validationFields$fie8.required);
};
exports.isRequiredField = isRequiredField;
var showField = function showField(fieldName) {
  var _validationFields$fie9, _validationFields$fie10, _validationFields$fie11, _validationFields$fie12, _validationFields$fie13, _validationFields$fie14, _validationFields$fie15;
  return !_validationFields.default || !_validationFields.default.loading && !((_validationFields$fie9 = _validationFields.default.fields) !== null && _validationFields$fie9 !== void 0 && (_validationFields$fie10 = _validationFields$fie9.checkout) !== null && _validationFields$fie10 !== void 0 && _validationFields$fie10[fieldName]) || !_validationFields.default.loading && ((_validationFields$fie11 = _validationFields.default.fields) === null || _validationFields$fie11 === void 0 ? void 0 : (_validationFields$fie12 = _validationFields$fie11.checkout) === null || _validationFields$fie12 === void 0 ? void 0 : _validationFields$fie12[fieldName]) && ((_validationFields$fie13 = _validationFields.default.fields) === null || _validationFields$fie13 === void 0 ? void 0 : (_validationFields$fie14 = _validationFields$fie13.checkout) === null || _validationFields$fie14 === void 0 ? void 0 : (_validationFields$fie15 = _validationFields$fie14[fieldName]) === null || _validationFields$fie15 === void 0 ? void 0 : _validationFields$fie15.enabled);
};
exports.showField = showField;
var getFixedFromPercentage = function getFixedFromPercentage(percentage, price) {
  var rate = percentage * price / 100;
  return rate;
};
exports.getFixedFromPercentage = getFixedFromPercentage;
var getOrderTypetext = function getOrderTypetext() {
  var orderTypes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var str = '';
  if (orderTypes.includes(1)) {
    str += 'Delivery, ';
  }
  if (orderTypes.includes(2)) {
    str += 'Pick Up, ';
  }
  if (orderTypes.includes(3)) {
    str += ' Eat In, ';
  }
  if (orderTypes.includes(4)) {
    str += ' Curbside, ';
  }
  if (orderTypes.includes(5)) {
    str += '	Driver thru';
  }
  return '(' + str + ')';
};
exports.getOrderTypetext = getOrderTypetext;
var generateUniqueCode = function generateUniqueCode(length) {
  var result = '';
...
var getOrderTypeInt = function getOrderTypeInt(str) {
  var int = 0;
  if (str == 'delivery') {
    int = 1;
  }
...
exports.getOrderTypeInt = getOrderTypeInt;
var dateCheck = function dateCheck(from, to, check) {
