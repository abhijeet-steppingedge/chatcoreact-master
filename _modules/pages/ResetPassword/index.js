...
var ResetPassword = function ResetPassword(props) {
  ...
  var resetPasswordProps = _objectSpread(_objectSpread({}, props), {}, {
    code: code,
    random: random,
    redirectResetPassword: function redirectResetPassword(_ref) {
      var code = _ref.code,
        random = _ref.random;
      events.emit('go_to_page', {
        page: 'reset_password',
        search: "?code=".concat(code, "&random=").concat(random)
      });
    },
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_HelmetTags.HelmetTags, {
    page: "resetpassword"
  }), /*#__PURE__*/_react.default.createElement(_orderingUi.ResetPassword, resetPasswordProps));
};
