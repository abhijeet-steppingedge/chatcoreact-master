...
var _BusinessProductsListing = _interopRequireDefault(require("../../components/BusinessProductsListing"));
...
var BusinessProductsList = function BusinessProductsList(props) {
  ...
  var productId = product && product.split('=')[1];
  ...
  var businessProductsProps = _objectSpread(_objectSpread({}, props), {}, {
    ...
    productId: productId,
    businessProps: ['id', 'name', 'header', 'logo', 'name', 'open', 'about', 'description', 'address', 'location', 'timezone', 'schedule', 'service_fee', 'delivery_price', 'distance', 'delivery_time', 'gallery', 'pickup_time', 'reviews', 'featured', 'offers', 'food', 'laundry', 'alcohol', 'groceries', 'slug', 'products', 'zones', 'tablenumbers'],
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_HelmetTags.HelmetTags, {
    page: "business",
    helmetTitle: (0, _orderingUi.capitalize)(store)
  }), /*#__PURE__*/_react.default.createElement(_BusinessProductsListing.default, businessProductsProps));
};
